...
class MSICreator {
    ...
    getSpecialFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stubExe = yield (0, rc_edit_1.createStubExe)(this.appDirectory, this.exe, this.shortName, this.manufacturer, this.description, this.windowsCompliantVersion, this.iconPath);
